...
Revision ID: fdc66ac5156c
Revises: 
Create Date: 2025-09-28 04:39:05.138532
...
def upgrade():
    ...
    sa.Column('time_completed', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
