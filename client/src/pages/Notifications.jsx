    ...
    const fetchFriendRequests = async () => {
      try {
        ...
        for (const user of allUsers) {
          ...
          const sentToMe = Array.isArray(userFriends)
            ? userFriends.find(
        ...
        <main className="flex-1 p-4 sm:p-6 pb-24 lg:pb-8 lg:ml-80">
          <div className="w-full max-w-4xl mx-auto space-y-6">
            ...
            <div className="space-y-4">
              <h2 className="text-lg sm:text-xl font-semibold text-background-dark">
                Incoming
              </h2>
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-sm font-semibold text-background-dark truncate">
                            {request.username}
                          </p>
                          <p className="text-xs text-background-dark/60">
