    ...
    <aside className="w-80 bg-background-light dark:bg-background-dark p-6 flex flex-col justify-between border-r border-primary/20 dark:border-primary/30">
      <div className="flex flex-col gap-8">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-gray-900 dark:text-white">Sophia</h1>
        </div>
        <nav className="flex flex-col gap-2">
          <Link className={`flex items-center gap-3 px-4 py-3 rounded-lg font-semibold ${activeTab === 'dashboard' ? 'bg-primary/20 dark:bg-primary/30 text-gray-900 dark:text-white' : 'hover:bg-primary/10 dark:hover:bg-primary/20 text-gray-600 dark:text-gray-400 font-medium'}`} to="/dashboard">
          ...
          <Link className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium ${activeTab === 'friends' ? 'bg-primary/20 dark:bg-primary/30 text-gray-900 dark:text-white font-semibold' : 'hover:bg-primary/10 dark:hover:bg-primary/20 text-gray-600 dark:text-gray-400'}`} to="/friends">
          ...
          <Link className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium ${activeTab === 'workouts' ? 'bg-primary/20 dark:bg-primary/30 text-gray-900 dark:text-white font-semibold' : 'hover:bg-primary/10 dark:hover:bg-primary/20 text-gray-600 dark:text-gray-400'}`} to="/workouts">
          ...
          <Link className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium ${activeTab === 'progress' ? 'bg-primary/20 dark:bg-primary/30 text-gray-900 dark:text-white font-semibold' : 'hover:bg-primary/10 dark:hover:bg-primary/20 text-gray-600 dark:text-gray-400'}`} to="/my-progress">
          ...
          <Link className={`flex items-center gap-3 px-4 py-3 rounded-lg font-medium ${activeTab === 'settings' ? 'bg-primary/20 dark:bg-primary/30 text-gray-900 dark:text-white font-semibold' : 'hover:bg-primary/10 dark:hover:bg-primary/20 text-gray-600 dark:text-gray-400'}`} to="/settings">
